...
public class SpellProjectile_Boulder extends ZenithProjectile implements EntityDetonator, LifeExpiredDetonator
{

	public SpellProjectile_Boulder()
	{
		super(Arrow.class, 20, ProjectileFlag.INVISIBLE, ProjectileFlag.DESTROY_ON_COLLISION);
	}
	@Override
	...
	public void onEntityCollision(EntityDamageByEntityEvent event)
	{
    	...
    	{
    		((LivingEntity) event.getEntity()).addPotionEffect(new PotionEffect(PotionEffectType.SLOW, 60, 99));
    	}
	}
